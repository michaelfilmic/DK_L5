...
int main(void)
{
  ...
  // create a csv file
  FILE *fp;
  char data_set_name[] = "./Q1a_5.csv";
  //file IO

  fp = fopen(data_set_name, "w");
  //cell/element name/type
  fprintf(fp, ("Max queue,"));
  ...
  for (int i = 0; i < (sizeof(MAX_QUEUE_LIST) / sizeof(int)); i++)
  {
    ...
    while ((random_seed = RANDOM_SEEDS[j++]) != 0)
    {
      ...
      data.max_queue = MAX_QUEUE_LIST[i];
      //data.current_packet_count = 0;
